<?php /* Smarty version Smarty-3.1.11, created on 2016-04-28 09:27:34
...
?>
					<tr>
						...
						<td style="text-align: right">
							<button type="button" class="btn btn-default" action="usuarios" title="Usuarios" empresa="<?php echo $_smarty_tpl->tpl_vars['row']->value['idEmpresa'];?>
